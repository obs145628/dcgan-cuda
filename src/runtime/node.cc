...
namespace rt
{
		       ...
		       const std::vector<Node*>& preds)
    {
		...
		Node* Node::op_conv2d(const dbl_t* input, const dbl_t* kernel, const int* strides, dbl_t* output,
													const int* input_size, const int* kernel_size, const std::vector<Node*>& preds)
    {
